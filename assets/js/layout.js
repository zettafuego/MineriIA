...
const Layout = (() => {
  const NAV = [
    { id: 'dashboard', href: 'dashboard.html', label: 'Panel de control', icon: 'home' },
    { id: 'diagnostico', href: 'diagnostico.html', label: 'Evaluación', icon: 'clipboard' },
    { id: 'documentos', href: 'documentos.html', label: 'Expediente', icon: 'folder' },
    { id: 'chat', href: 'chat.html', label: 'Asistente IA', icon: 'chat' },
    { id: 'institucional', href: 'institucional.html', label: 'Metodología', icon: 'info' },
        ...
        <aside id="sidebar" class="sidebar" aria-label="Navegación principal">
          <div class="sidebar-brand">
            ...
            <div>
              ...
              <div class="brand-sub">Orientación para la formalización</div>
            </div>
          </div>
        ...
        <div class="main-wrap">
          <header class="navbar">
            ...
            <div class="navbar-right">
              <span class="environment-pill">MVP institucional</span>
          ...
          <main class="content">
            ...
            <footer class="app-footer">
              <span>FormalizaAI · Herramienta de orientación referencial</span>
              <span class="app-footer-links">
                <a href="institucional.html#metodologia">Metodología</a>
                <a href="institucional.html#fuentes">Fuentes</a>
                <a href="institucional.html#alcance">Alcance y limitaciones</a>
              </span>
            </footer>
          </main>
        </div>
